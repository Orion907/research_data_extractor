...
from src.utils.data_extractor import DataExtractor  # Changed to match your structure
from src.data_export.csv_exporter import save_to_csv  # Assuming this is the correct path
...
def main():
    ...
    try:
        # Initialize the DataExtractor with the Anthropic API
        extractor = DataExtractor(provider="anthropic")
        
        # Extract data from the first few chunks to save API usage
